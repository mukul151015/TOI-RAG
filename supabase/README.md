...
The frontend still needs to be pointed at these function URLs with bearer-token auth, and the overlapping FastAPI auth/catalog/chat routes can then be removed or turned into thin proxies.
